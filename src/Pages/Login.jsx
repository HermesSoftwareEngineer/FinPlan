...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-secondary-50 to-accent-50 dark:from-dark-bg dark:via-dark-bg-secondary dark:to-dark-bg-tertiary flex items-center justify-center p-4">
      <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-light-bg-secondary dark:bg-dark-bg-tertiary border border-light-border dark:border-dark-border rounded-lg text-light-text dark:text-dark-text placeholder-light-text-tertiary dark:placeholder-dark-text-tertiary focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4 h-4 text-primary-600 bg-light-bg-secondary dark:bg-dark-bg-tertiary border-light-border dark:border-dark-border rounded focus:ring-2 focus:ring-primary-500"
                />
                <label htmlFor="rememberMe" className="ml-2 text-sm text-light-text-secondary dark:text-dark-text-secondary">
                  Lembrar-me
                </label>
              </div>
        ...
        <p className="text-center mt-6 text-light-text-secondary dark:text-dark-text-secondary">
          Não tem uma conta?{' '}
          <Link to="/cadastrar" className="font-semibold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition">
