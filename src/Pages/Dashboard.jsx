          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-dark-bg-secondary rounded-xl p-6 border border-light-border dark:border-dark-border shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link to="/movimentos" className="text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300">
                  Ver todas →
                </Link>
              </div>
              <div className="space-y-3">
                {/* Transação 1 */}
                <div className="flex items-center justify-between p-3 bg-light-bg-secondary dark:bg-dark-bg-terciary rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-success-100 dark:bg-success-900/30 rounded-lg flex items-center justify-center">
                      <span className="text-xl">💼</span>
                    </div>
                    <div>
                      <p className="font-medium text-light-text dark:text-dark-text">Salário</p>
                      <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">25 Out 2025</p>
                    </div>
                  </div>
                  <span className="font-semibold text-success-600 dark:text-success-400">+R$ 5.000,00</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-light-bg-secondary dark:bg-dark-bg-terciary rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-light-text dark:text-dark-text">Supermercado</p>
                      <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">24 Out 2025</p>
                    </div>
                  </div>
                  <span className="font-semibold text-danger-600 dark:text-danger-400">-R$ 320,50</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-light-bg-secondary dark:bg-dark-bg-terciary rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-light-text dark:text-dark-text">Conta de Luz</p>
                      <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">23 Out 2025</p>
                    </div>
                  </div>
                  <span className="font-semibold text-danger-600 dark:text-danger-400">-R$ 185,00</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-dark-bg-secondary rounded-xl p-6 border border-light-border dark:border-dark-border shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link to="/metas" className="text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300">
                  Ver todas →
                </Link>
              </div>
              <div className="space-y-4">
                {/* Meta 1 */}
                <div className="p-4 bg-light-bg-secondary dark:bg-dark-bg-terciary rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className="text-xl">🏖️</span>
                      <span className="font-medium text-light-text dark:text-dark-text">Viagem</span>
                    </div>
                    <span className="text-sm font-semibold text-primary-600 dark:text-primary-400">75%</span>
                  </div>
                  <div className="w-full bg-white dark:bg-dark-bg rounded-full h-2 mb-2">
                ...
                <div className="p-4 bg-light-bg-secondary dark:bg-dark-bg-terciary rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className="text-xl">💻</span>
                      <span className="font-medium text-light-text dark:text-dark-text">Notebook Novo</span>
                    </div>
                    <span className="text-sm font-semibold text-secondary-600 dark:text-secondary-400">45%</span>
                  </div>
                  <div className="w-full bg-white dark:bg-dark-bg rounded-full h-2 mb-2">
                    <div className="bg-gradient-to-r from-secondary-500 to-primary-500 h-2 rounded-full" style={{ width: '45%' }}></div>
                  </div>
                  <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">
                    R$ 1.350 de R$ 3.000
                  </p>
                ...
                <div className="p-4 bg-light-bg-secondary dark:bg-dark-bg-terciary rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className="text-xl">🚗</span>
                      <span className="font-medium text-light-text dark:text-dark-text">Carro</span>
                    </div>
                    <span className="text-sm font-semibold text-accent-600 dark:text-accent-400">18%</span>
                  </div>
                  <div className="w-full bg-white dark:bg-dark-bg rounded-full h-2 mb-2">
                    <div className="bg-gradient-to-r from-accent-500 to-primary-500 h-2 rounded-full" style={{ width: '18%' }}></div>
                  </div>
                  <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">
                    R$ 5.400 de R$ 30.000
                  </p>
